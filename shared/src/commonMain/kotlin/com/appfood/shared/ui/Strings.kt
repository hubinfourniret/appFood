...
const val JOURNAL_PORTION_GENERIC = "Portions generiques"
    ...
    const val JOURNAL_EDIT_GRAMMES_LABEL = "Quantite (g)"
    const val JOURNAL_EDIT_PORTIONS_LABEL = "Nombre de portions"
    ...
    const val RECETTE_SAVE_CHANGES = "Enregistrer"
    const val RECETTE_ETAPES_TITLE = "Preparation"
    const val RECETTE_NUTRITION_TITLE = "Valeurs nutritionnelles (pour cette saisie)"
    ...
    // ===========================================
    const val SOCIAL_ONBOARDING_TITLE = "Profil communautaire"
    const val SOCIAL_ONBOARDING_INTRO = "Configure ton profil pour utiliser la partie communautaire d'appFood. Tu pourras partager des recettes et decouvrir celles des autres."
    const val SOCIAL_HANDLE_LABEL = "Pseudo (handle)"
    const val SOCIAL_HANDLE_HELPER = "3 a 30 caracteres : lettres, chiffres, underscore"
    const val SOCIAL_HANDLE_CHECKING = "Verification..."
    const val SOCIAL_HANDLE_AVAILABLE = "Pseudo disponible"
    const val SOCIAL_HANDLE_TAKEN = "Pseudo deja pris"
    const val SOCIAL_HANDLE_INVALID = "Format invalide (3-30 caracteres : a-z, 0-9, _)"
    const val SOCIAL_BIO_LABEL = "Bio (optionnel)"
    const val SOCIAL_BIO_HELPER = "280 caracteres max"
    const val SOCIAL_DATE_NAISSANCE_LABEL = "Date de naissance"
    const val SOCIAL_DATE_NAISSANCE_HELPER = "Au format JJ/MM/AAAA. Cette date est definitive."
    const val SOCIAL_DATE_DAY = "Jour"
    const val SOCIAL_DATE_MONTH = "Mois"
    const val SOCIAL_DATE_YEAR = "Annee"
    const val SOCIAL_DATE_INVALID = "Date invalide"
    const val SOCIAL_AGE_TOO_YOUNG = "Tu dois avoir au moins 13 ans pour utiliser appFood"
    const val SOCIAL_VISIBILITY_LABEL = "Visibilite de ton profil"
    const val SOCIAL_VISIBILITY_PRIVATE = "Prive"
    const val SOCIAL_VISIBILITY_PRIVATE_DESC = "Seul toi voit ton contenu"
    const val SOCIAL_VISIBILITY_FRIENDS = "Amis seulement"
    const val SOCIAL_VISIBILITY_FRIENDS_DESC = "Visible uniquement par les utilisateurs avec qui tu as un follow mutuel"
    const val SOCIAL_VISIBILITY_PUBLIC = "Public"
    const val SOCIAL_VISIBILITY_PUBLIC_DESC = "Visible par tous les utilisateurs"
    const val SOCIAL_SUBMIT = "Continuer"
    const val SOCIAL_SUBMIT_SAVING = "Enregistrement..."
    const val SOCIAL_NOTE_AGE_GATE = "L'acces a la communaute est reserve aux 16 ans et plus. Tu pourras toutefois utiliser tout le tracker nutritionnel."
    const val SOCIAL_SETTINGS_TITLE = "Profil social"
    const val SOCIAL_SETTINGS_DATE_LOCKED = "La date de naissance ne peut pas etre modifiee."
    const val SOCIAL_SETTINGS_SAVE = "Enregistrer"
    const val SOCIAL_SETTINGS_SAVED = "Profil mis a jour"
    const val SETTINGS_SOCIAL_PROFILE = "Profil social"
}
