...
class HydratationDao {
    ...
    suspend fun findByUserAndDate(userId: String, date: LocalDate): HydratationRow? = dbQuery {
    ...
    suspend fun insert(row: HydratationRow): HydratationRow = dbQuery {
    ...
    suspend fun updateQuantite(id: String, userId: String, quantiteMl: Int): Boolean = dbQuery {
    ...
    suspend fun insertEntry(row: HydratationEntryRow): HydratationEntryRow = dbQuery {
    ...
    suspend fun deleteEntry(id: String): Boolean = dbQuery {
    ...
    private fun ResultRow.toEntryRow() = HydratationEntryRow(
