...
class PortionDao {
    suspend fun findById(id: String): PortionRow? =
        dbQuery {
        ...
        dbQuery {
            PortionsTable.selectAll()
                .where {
                    ...
                    val base =
                        (PortionsTable.alimentId eq alimentId) or
    ...
    suspend fun findGeneriques(): List<PortionRow> =
        dbQuery {
            PortionsTable.selectAll()
    ...
    suspend fun findByUserId(userId: String): List<PortionRow> =
        dbQuery {
            PortionsTable.selectAll()
    ...
    suspend fun insert(row: PortionRow): PortionRow =
        dbQuery {
