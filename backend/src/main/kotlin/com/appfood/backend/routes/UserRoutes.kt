    ...
    authenticate("auth-jwt") {
        route("/api/v1/users") {
            ...
            put("/me/preferences") {
                ...
                call.respond(
                    HttpStatusCode.OK,
                    preferences.toPreferencesResponse(),
                )
            }
            ...
            get("/me/export") {
                ...
                val export =
                    UserExportResponse(
                        ...
                        poidsHistory =
                            exportData.poidsHistory.map { poids ->
                                PoidsExportResponse(
                                    id = poids.id,
                        ...
                        consentements =
                            exportData.consentements.map { c ->
...
internal fun UserProfileRow.toProfileResponse() =
    ProfileResponse(
        sexe = sexe.name,
        age = age,
        poidsKg = poidsKg,
...
internal fun UserPreferencesRow.toPreferencesResponse() =
    PreferencesResponse(
