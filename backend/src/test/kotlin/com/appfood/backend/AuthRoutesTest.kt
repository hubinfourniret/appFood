...
class AuthRoutesTest {
    ...
    @Test
    fun `should register new user successfully`() = withTestApp {
        // Given
        ...
        val response = client.post("/api/v1/auth/register") {
            ...
            setBody("""{"firebaseToken":"test-uid-001:newuser@example.com","email":"newuser@example.com","nom":"Dupont","prenom":"Jean"}""")
        }
    ...
    @Test
    fun `should register user without nom and prenom`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return conflict when registering with existing email`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return conflict when registering with existing firebase uid`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should login successfully after registration`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return unauthorized when logging in with unregistered user`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return error when register body is missing required fields`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return unauthorized when accessing protected endpoint without token`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return unauthorized when accessing protected endpoint with invalid token`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return unauthorized when accessing protected endpoint with expired token`() = withTestApp {
        // Given
        val client = createJsonClient()
    ...
    @Test
    fun `should return valid JWT token that works on protected endpoints`() = withTestApp {
        // Given
        val client = createJsonClient()
        ...
        val token = body["data"]!!.jsonObject["token"]!!.jsonPrimitive.content
        ...
        val userData = meBody["data"]!!.jsonObject["user"]!!.jsonObject
